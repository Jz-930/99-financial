                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/corporate-par" className="hover:text-brand-gold transition">Corporate Par</Link></li>
                            <li><Link href="/cda" className="hover:text-brand-gold transition">CDA Planning</Link></li>
                            <li><Link href="/ifa" className="hover:text-brand-gold transition">IFA Strategy</Link></li>
                            <li><Link href="/estate-planning" className="hover:text-brand-gold transition">Estate Planning</Link></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-white font-bold uppercase text-xs border-l-2 border-brand-gold pl-3 mb-4">Resources</h4>
                        <ul className="space-y-2">
                            <li><Link href="/resources" className="hover:text-brand-gold transition">Downloads</Link></li>
                            <li><Link href="/case-studies" className="hover:text-brand-gold transition">Case Studies</Link></li>
                            <li><Link href="/events" className="hover:text-brand-gold transition">Events</Link></li>
                            <li><Link href="/faq" className="hover:text-brand-gold transition">FAQ</Link></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="text-white font-bold uppercase text-xs border-l-2 border-brand-gold pl-3 mb-4">Legal</h4>
                        <ul className="space-y-2">
                        ...
                        <a href="https://tidycal.com/greatec/30-minute-meeting" className="inline-block mt-4 border border-slate-700 px-4 py-2 rounded text-xs hover:bg-brand-gold hover:text-white transition">Book a Meeting</a>
                    </div>
                </div>
