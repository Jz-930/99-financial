    ...
    return (
        <main className="bg-white">
            <HeroSection
                ...
                subtitle="A Structural Exit Mechanism for Corporate Wealth"
            />
            ...
            <SectionContainer className="py-20 lg:py-24">
                <ScrollAnimation className="fade-in-up">
                    <h2 className="text-3xl font-serif font-bold text-brand-blue mb-12 text-center">Where CDA Fits in the Corporate Wealth Flow</h2>
                </ScrollAnimation>

                <ScrollAnimation className="fade-in-up">
                    <div className="text-lg text-slate-600 mb-10 max-w-3xl mx-auto text-center">
                    ...
                    <p className="mt-10 text-slate-600 italic max-w-2xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <ScrollAnimation className="fade-in-left">
                            ...
                            <ul className="space-y-4 mb-8">
                                <IconListItem icon="fa-solid fa-caret-right" className="">Corporate-owned life insurance proceeds (net of policy ACB)</IconListItem>
                                <IconListItem icon="fa-solid fa-caret-right" className="">Certain capital gains components</IconListItem>
                                <IconListItem icon="fa-solid fa-caret-right" className="">Other qualifying capital transactions</IconListItem>
                            </ul>
                        ...
                        <ul className="space-y-4 mb-8 text-slate-700">
                            {[
                                ...
                                <li key={i} className="flex items-start">
                                    <i className="fa-solid fa-circle-xmark text-red-400 mt-1.5 mr-3"></i>
                                    {item}
                                </li>
                            ))}
                        </ul>
            ...
            <CTASection
                ...
                description={<>CDA planning is not universally relevant — but when it is, it should be addressed intentionally and early within the corporate planning process.<br /><br />Understand whether CDA planning is structurally appropriate for your corporation.</>}
                extraContent={
                    <>
