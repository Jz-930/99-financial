    ...
    return (
        <main className="bg-white">
            ...
            <div>
                ...
                {/* Founder’s Perspective with Image (Gray) */}
                ...
                {/* Our Professional Approach (White) */}
                <section className="py-20 bg-white">
                    <div className="max-w-3xl mx-auto px-6">
                ...
                {/* A Collaborative Advisory Model (Gray) */}
                <section className="py-20 bg-slate-100">
                    <div className="max-w-3xl mx-auto px-6">
                ...
                {/* A Long-Term Planning Philosophy (Gray) */}
                <section className="py-20 bg-slate-100">
                    <div className="max-w-3xl mx-auto px-6">
