...
const caseStudies = [
    {
        ...
        image: '/images/Construction-Design-Firm.webp',
        imageAlt: 'Construction Design Firm Background',
        number: '01',
    ...
    },
    {
        ...
        image: '/images/Corporate-IFA-Strategy.webp',
        imageAlt: 'Corporate IFA Strategy Background',
        number: '02',
    ...
    },
    {
        ...
        image: '/images/Veterinary-Succession.webp',
        imageAlt: 'Veterinary Succession Background',
        number: '03',
        ...
        <main className="bg-white">
            ...
            <section className="py-16 md:py-24 relative bg-brand-light/30">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
                    ...
                    {caseStudies.map((cs, i) => (
                        <ScrollAnimation key={i} className="fade-in-up">
                            <div className={`bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden hover:shadow-2xl transition duration-500 hover:border-brand-gold/50 flex flex-col ${cs.flexDir} group`}>
                                {/* Abstract Visual Section */}
                                <div className={`lg:w-1/3 ${i === 1 ? 'bg-slate-900' : 'bg-slate-800'} min-h-[200px] lg:min-h-[300px] relative overflow-hidden flex items-center justify-center p-8`}>
                                    <Image
                                        src={cs.image}
                                        alt={cs.imageAlt}
                                        fill
                                    ...
                                    />
                                    <div className={`absolute inset-0 ${cs.gradientDir} from-slate-900/50 to-slate-800/50`}></div>

                                    <div className="relative z-10 text-center">
                                        <span className="block text-brand-gold font-bold text-6xl mb-2 opacity-20">{cs.number}</span>
                                        <h3 className="text-white font-serif text-2xl font-bold leading-tight">{cs.visualTitle}</h3>
                ...
                <div className="mt-16 md:mt-24 max-w-4xl mx-auto text-center px-4">
                    <ScrollAnimation className="fade-in-up">
                        <div className="rounded-xl p-8 md:p-14 shadow-2xl relative overflow-hidden">
                            <video
                                autoPlay
                                muted
                                loop
                            ...
                            <div className="relative z-10">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    className="inline-block bg-brand-gold text-white text-base md:text-lg font-bold py-3 px-8 md:py-4 md:px-10 rounded-sm hover:bg-white hover:text-brand-blue transition-all duration-300 shadow-xl uppercase tracking-widest"
                                >
